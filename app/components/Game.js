...
function Game ({ id, innings, mercyRuns, noMercyInningBegin, positions, fielding, battingOrder, statusGrid, lockedInnings, advanceRunner, onScoresheetChange, toggleInningLock }) {
  return (
    <div>
      <OffenseTable
        innings={innings}
